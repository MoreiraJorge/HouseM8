...
document.getElementById("sendButton").addEventListener("click", function (event) {
    ...
    var sender = document.getElementById("senderIdInput").value;
    var target = document.getElementById("targetIdInput").value;
    var message = document.getElementById("messageInput").value;
    var connectionId = document.getElementById("groupInput").value;
    var d = new Date();

    connection.invoke("SendPrivateMessage", connectionId, user, message, d, target, sender).catch(function (err) {
        return console.error(err.toString());
    });
