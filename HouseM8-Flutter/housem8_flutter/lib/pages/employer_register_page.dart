...
class _EmployerRegisterScreen extends State<EmployerRegisterPage> {
    ...
    return TextFormField(
      ...
      validator: (String value) {
        ...
        if (value.length == 0) {
          ...
          return "O username deve ter no minimo 6 caracteres";
        }
        return null;
      },
      onSaved: (String value) {
    ...
    return TextFormField(
      ...
      validator: (String value) {
        ...
        if (value.length == 0) {
          ...
          return "A rua deve ter no minimo 6 caracteres";
        }
        return null;
      },
  ...
  Widget streetNumberWidget() {
    return TextFormField(
      decoration: InputDecoration(
          labelText: 'Numero de rua', helperText: 'Insira o numero de rua'),
      ...
      validator: (String value) {
        ...
        RegExp regExp = new RegExp(patttern);
        if (value.length == 0) {
          return "Introduza o numero da rua";
        }
        return null;
      },
  ...
  Widget postalCodeWidget() {
    return TextFormField(
      ...
      validator: (String value) {
        ...
        RegExp regExp = new RegExp(patttern);
        if (value.length == 0) {
          return "Introduza o seu codigo postal";
        } else if (value.length < 3) {
          return "O codigo postal deve ter no minimo 4 caracteres";
        }
        return null;
      },
    ...
    return TextFormField(
      ...
      validator: (String value) {
        ...
        if (value.length == 0) {
          ...
          return "O distrito deve ter no minimo 6 caracteres";
        }
        return null;
      },
    ...
    return TextFormField(
      ...
      validator: (String value) {
        ...
        if (value.length == 0) {
          ...
          return "O país deve ter no minimo 3 caracteres";
        }
        return null;
      },
  ...
  Widget descriptionWidget() {
    return TextFormField(
      decoration: InputDecoration(
          labelText: 'Descricao', helperText: 'Fale um pouco sobre si'),
      maxLength: 50,
      validator: (String value) {
        String patttern = r'(^[a-zA-Z ]*$)';
        RegExp regExp = new RegExp(patttern);
        if (value.length == 0) {
          ...
          return "A descrição deve ter no minimo 15 caracteres";
        }
        return null;
      },
      onSaved: (String value) {
